...
@php
    ...
    // Show minimal sidebar (Dashboard only) on the main app routes.
    // UI reference pages (/ui/*) get the full menu.
    $isUiReference = request()->is('ui*');

    $menuGroups = $isUiReference
        ? MenuHelper::getMenuGroups()
        : MenuHelper::getDashboardMenuGroups();
@endphp
