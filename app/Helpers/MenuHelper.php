...
class MenuHelper
{
    public static function getMainNavItems()
    {
        return [
            ...
            [
                ...
                'icon' => 'forms',
                'subItems' => [
                    ['name' => 'Form Elements', 'path' => '/ui/form-elements', 'pro' => false],
                ],
            ],
            [
                'name' => 'Tables',
            ...
            [
                ...
                'icon' => 'pages',
                'subItems' => [
                    ['name' => 'Blank Page', 'path' => '/ui/blank', 'pro' => false],
                    ['name' => '404 Error', 'path' => '/ui/error-404', 'pro' => false],
                ],
            ],
        ];
    }
        ...
        return [
            ...
            [
                ...
                'subItems' => [
                    ...
                    ['name' => 'Images',  'path' => '/ui/image',   'pro' => false],
            ...
            [
                ...
                'name' => 'Authentication',
                'subItems' => [
                    ['name' => 'Sign In', 'path' => '/ui/signin', 'pro' => false],
                    ['name' => 'Sign Up', 'path' => '/ui/signup', 'pro' => false],
                ],
            ],
        ];
    }
    ...
    /**
     * App sidebar menu — three states:
     *
     * 1. No active vertical  → Global Dashboard only
     * 2. Active vertical, on /  or /dashboard → Global + Vertical Dashboard + modules
     * 3. Active vertical, on /leads/* → same as (2)
     */
    public static function getDashboardMenuGroups(): array
    {
        ...
        // No vertical selected — just show global
        if (! $slug) {
            return [$globalGroup];
        }

        // ── Group 2: Active vertical ──────────────────────────────────────────
        $configPath = config_path("verticals/{$slug}.php");
        ...
        // Vertical Dashboard as first item in vertical group
        $verticalItems = [
            [
                'icon' => 'ecommerce',
                'name' => 'Dashboard',
        ...
        // Leads module
        if (in_array('leads', $config['modules'])) {
            $verticalItems[] = [
                'icon'     => 'task',
                'name'     => 'Leads',
                'subItems' => [
                    ['name' => 'All Leads', 'path' => '/leads'],
                    ['name' => 'Add Lead',  'path' => '/leads/create'],
                ],
            ];
        }
        ...
        return [$globalGroup, $verticalGroup];
    }
